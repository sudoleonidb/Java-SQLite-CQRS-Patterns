...
//Мы создаём соединение с базой данных SQLite.
//Если таблица пользователей еще не существует, мы её создаём.
//Затем мы добавляем пользователя "John Doe" с помощью класса AddUserCommand.
//Запрашиваем список всех пользователей с помощью GetAllUsersQuery и выводим их имена.